...
namespace OpenStore.Api.Azure
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        {
            Trace.TraceInformation("OpenStore.Api.Azure is running");
        ...
        public override bool OnStart()
        {
            ...
            this.app = WebApp.Start<App>(new StartOptions(url: baseUri));

            bool result = base.OnStart();

            Trace.TraceInformation("OpenStore.Api.Azure has been started");
        ...
        {
            Trace.TraceInformation("OpenStore.Api.Azure is stopping");
            ...
            Trace.TraceInformation("OpenStore.Api.Azure has stopped");
        }
